        ...
        <div class="card mb-4">
            <div class="card mb-4">
                <div class="card-body" id="printThis">
                    ...
                    <div class="col-md-12">
                        <h2 class="pt-3 pb-1 text-center font-bold font-up deep-purple-text">VOTERS PROFILES</h2>
                    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ ucfirst($voters->last_name)}}, {{ucfirst($voters->first_name)}}  {{ucfirst(substr($voters->last_name, 0,1)) }}.</td>
                                <td>{{$voters->age}}</td>
                                <td>{{$voters->birthdate}}</td>
                                <td>{{$voters->street}}</td>
                                <td>{{$voters->civil_status}}</td>
                                <td style=" text-align:center">{{$voters->voter_status}}</td>
                            </tr>
                        </tbody>
                        @endforeach
                        <!--Table body-->
