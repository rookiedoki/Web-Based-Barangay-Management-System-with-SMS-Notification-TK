       ...
       <h4>RESIDENT PROFILES BY AGE</h4>
            ...
            <div class="card mb-40 ">
                <div class="card-body " id="printThis">
                    ...
                    <div class="col-md-12">
                        <h2 class="pt-3 pb-1 text-center font-bold font-up deep-purple-text">AGE</h2>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ ucfirst($ages->last_name)}}, {{ucfirst($ages->first_name)}}  {{ucfirst(substr($ages->last_name, 0,1)) }}.</td>
                                <td>{{ucfirst($ages->nickname)}}</td>
                                <td>{{$ages->age}}</td>
                                <td style=" text-align:center">{{$ages->birthdate}}</td>
                                <td style=" text-align:center">{{$ages->civil_status}}</td>
                            </tr>
                        </tbody>
                        @endforeach
                        <!--Table body-->
