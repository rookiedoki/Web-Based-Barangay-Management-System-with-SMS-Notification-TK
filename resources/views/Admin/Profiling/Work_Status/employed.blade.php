...
<body class="hm-gradient" >
    ...
    <main>
        ...
        <h2 class="mb-1 pt-2">Employed</h2>
            ...
            <div class="card mb-4">
                <div class="card-body" id="printThis">
                    ...
                    <div class="col-md-12">
                        <h2 class="pt-3 pb-1 text-center font-bold font-up deep-purple-text">EMPLOYED RESIDENTS</h2>
                    ...
                    <table class="table table-hover">
                        ...
                        <!--Table head-->
                        <!--Table body-->
                        @foreach($emp as $employed)
                        <tbody>
                            <tr>
                                <th scope="row">{{$loop->iteration }}</th>
                                <td>{{ ucfirst($employed->last_name)}}, {{ucfirst($employed->first_name)}}  {{ucfirst(substr($employed->last_name, 0,1)) }}.</td>
                                <td>{{$employed->age}}</td>
                                <td>{{$employed->birthdate}}</td>
                                <td>{{$employed->civil_status}}</td>
                                <td>{{$employed->occupation}}</td>
                                <td style=" text-align:center">{{$employed->work_status}}</td>
                            </tr>
                        </tbody>
                        @endforeach
                        <!--Table body-->
