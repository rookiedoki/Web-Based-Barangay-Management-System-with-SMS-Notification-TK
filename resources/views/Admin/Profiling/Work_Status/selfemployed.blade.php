...
<body class="hm-gradient" >
    ...
    <main>
        ...
        <h2 class="mb-1 pt-2">Self Employed</h2>
            ...
            <div class="card mb-4">
                <div class="card-body" id="printThis">
                    ...
                    <div class="col-md-12">
                        <h2 class="pt-3 pb-1 text-center font-bold font-up deep-purple-text">Self Employed Residents</h2>
                    ...
                    <table class="table table-hover">
                        ...
                        <!--Table head-->
                        <!--Table body-->
                        @foreach($selfemp as $selfemployed)
                        <tbody>
                            <tr>
                                <th scope="row">{{$loop->iteration }}</th>
                                <td>{{ ucfirst($selfemployed->last_name)}}, {{ucfirst($selfemployed->first_name)}}  {{ucfirst(substr($selfemployed->last_name, 0,1)) }}.</td>
                                <td>{{$selfemployed->age}}</td>
                                <td>{{$selfemployed->birthdate}}</td>
                                <td>{{$selfemployed->status}}</td>
                                <td>{{$selfemployed->occupation}}</td>
                                <td style=" text-align:center">{{$selfemployed->work_status}}</td>
                            </tr>
                        </tbody>
                        @endforeach
                        <!--Table body-->
