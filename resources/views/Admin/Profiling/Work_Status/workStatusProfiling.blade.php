...
<body class="hm-gradient" >
    ...
    <main>
        ...
        <h2 class="mb-1 pt-2">Work Status Profiling</h2>
            ...
            <div class="card mb-4">
                <div class="card-body" id="printThis">
                    ...
                    <div class="col-md-12">
                        <h2 class="pt-3 pb-1 text-center font-bold font-up deep-purple-text">WORK STATUS</h2>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ucfirst($status->last_name)}}, {{ucfirst($status->first_name)}}  {{ucfirst(substr($status->last_name, 0,1)) }}.</td>
                                <td>{{$status->age}}</td>
                                <td>{{$status->birthdate}}</td>
                                <td>{{$status->civil_status}}</td>
                                <td>{{$status->occupation}}</td>
                                <td style=" text-align:center">{{$status->work_status}}</td>
                            </tr>
                        </tbody>
                        @endforeach
                        <!--Table body-->
