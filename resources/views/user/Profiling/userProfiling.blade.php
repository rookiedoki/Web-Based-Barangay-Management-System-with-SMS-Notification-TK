      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form action="/storeVaccination" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                          ...
                          <select class="form-control" name="vaccine_type" value="{{old('vaccine_type')}}" required autocomplete="work_status" value="{{old('work_status')}}">
                            <option value="">-Type of Vaccine-</option>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="dose" value="{{old('vaccine_type')}}" required autocomplete="dose" value="{{old('dose')}}">
                      <option value="">-Please Select-</option>
                      <option value="Partially Vaccinated">Partially Vaccinated</option>
                      <option value="Fully Vaccinated">Fully Vaccinated</option>
                      <option value="With Booster">With Booster</option>
                   </select>
                 ...
                 <div class="form-group col-md-6">
                    ...
                    @enderror
                        ...
                        <div class="form-group col-md-6">
                          <label for="inputZip">Date of Booster</label>
                          <input type="date"  name="booster_date" class="form-control" >
